...
CONSTRUCTTEXT = FONTTYPE.render("Construct", True, BLACK)
BACKSPACETEXT = FONTTYPE.render("Backspace to exit", True, BLACK)
INSTRUCTIONTEXT = FONTTYPE.render("WASD to move. Spacebar to build. Right and left arrows to cycle buildings.",True,BLACK,)

CONSTRUCTBUTTON = pygame.Rect(720, 80, 80, 80)

CONSTRUCTBUTTONSELECTED = pygame.Rect(720, 80, 80, 80)